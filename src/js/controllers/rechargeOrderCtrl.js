...
app.controller('RechargeOrderCtrl', ['$scope', 'i18nService', '$http', '$filter', function ($scope, i18nService, $http, $filter) {
    ...
    vm.gridOptionsRechargeOrder = {
        ...
        columnDefs: [
            ...
            { name: 'pay_money', enableFiltering: false, displayName: '支付金额' },
            { name: 'paid_at', enableFiltering: false, displayName: '支付时间' },
            { name: 'status', enableFiltering: false, displayName: '支付状态' }
        ],
        data: []
    };
